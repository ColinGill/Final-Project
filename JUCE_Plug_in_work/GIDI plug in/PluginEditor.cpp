...
JuceDemoPluginAudioProcessorEditor::JuceDemoPluginAudioProcessorEditor (JuceDemoPluginAudioProcessor& owner)
    : AudioProcessorEditor (owner),
      ...
      timecodeDisplayLabel (String(), "Note Hz:"),
...
void JuceDemoPluginAudioProcessorEditor::timerCallback()
{
    ...
    updateText (getProcessor().trackProperties.name);
}
...
void JuceDemoPluginAudioProcessorEditor::updateGui(String c)
{
	String text = c;
	timecodeDisplayLabel.setText(text , dontSendNotification);
	//gainLabel.setText(c, dontSendNotification);
	//repaint();
}
...
void JuceDemoPluginAudioProcessorEditor::updateText(String)
{
	timecodeDisplayLabel.setText("hi there", dontSendNotification);
	gainLabel.setText("clip", dontSendNotification);
}
